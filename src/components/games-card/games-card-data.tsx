...
const gamesCardData: Array<GamesInfoProps> = [
  {
    title: 'Спринт',
    description: 'Тренирует навык быстрого перевода с английского языка на русский. Выбирайте соответствует ли перевод предложенному слову и получайте очки,при правильном ответе.',
    path: 'sprint',
    wordsCount: 12,
  },
  {
